    ...
    MENUMAC: {
        "root": {
            name: "menu", step: 0, items: [
                ...
                { name: "Window", step: 3, items: [{ name: "Minimize", step: 0 }, { name: "Close", step: 1 }, { name: "Auto Launch On Startup", step: 2 }, { name: "Always on Top", step: 3 }, { name: "Minimize on Close", step: 4 }] },
